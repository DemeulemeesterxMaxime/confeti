...
2. (option) brancher une musique, 5. verifier.
...
- **Photo** : remplace le `<div class="photo-ph" data-slot="N" ...>Ta photo ici</div>`
  ...
  ```html
  <img
    src="<chemin-ou-data-url>"
    alt=""
    style="width:clamp(240px,30vw,360px);height:clamp(300px,38vw,450px);object-fit:cover;border-radius:3px;"
  />
  ```
